...
if [[ "$OS" == "macos" ]] && command_exists brew; then
    BREW_PACKAGES=(eza starship zsh-autosuggestions zsh-syntax-highlighting zoxide asdf gh tmux ripgrep fd lazygit azure-cli kubernetes-cli kubecolor docker pngpaste)
